(function () {
  ...
  const ENDPOINT = 'https://southamerica-east1-nexonda-281084.cloudfunctions.net/logInsight';
  const MAX_EVENTS = 10;
      ...
      try {
        if (logoData) {
          ...
          if (details.clientFantasyName) {
            fetch('https://southamerica-east1-nexonda-281084.cloudfunctions.net/trackLogoClick', {
              method: 'POST',
